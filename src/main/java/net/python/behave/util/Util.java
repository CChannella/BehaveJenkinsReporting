...
public class Util {
    ...
    public static String formatDuration(double duration) {
        PeriodFormatter formatter = new PeriodFormatterBuilder()
                ...
                .appendSuffix(" ms", " ms")
                .toFormatter();
        return formatter.print(new Period(0, (long) (duration / 1000000)));
    }
    ...
    public static boolean hasScenarios(BehaveFeature feature) {
