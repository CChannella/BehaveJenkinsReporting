...
public class ReportInformation {
    ...
    private Map<String, List<BehaveFeature>> projectFeatureMap;
    private List<BehaveFeature> features;
    ...
    private double totalDuration = 0l;
    ...
    private List<BehaveFeature> listAllFeatures() {
        List<BehaveFeature> allFeatures = new ArrayList<BehaveFeature>();
        Iterator it = projectFeatureMap.entrySet().iterator();
        while (it.hasNext()) {
            Map.Entry pairs = (Map.Entry) it.next();
            List<BehaveFeature> featureList = (List<BehaveFeature>) pairs.getValue();
            allFeatures.addAll(featureList);
        }
        return allFeatures;
    }

    public List<BehaveFeature> getFeatures() {
    ...
    public Map<String, List<BehaveFeature>> getProjectFeatureMap() {
    ...
    public String getReportStatusColour(BehaveFeature feature) {
    ...
    public double getLongTotalTagDuration() {
    ...
    private void processFeatures() {
        for (BehaveFeature feature : features) {
            ...
            if (Util.itemExists(scenarios)) {
                ...
                /*if (feature.hasTags()) {
                    ...
                    System.out.print(feature.getTagList());
                    String [] tl ={"1"};
                    tagMap = createOrAppendToTagMapByFeature(tagMap,tl , scenarioList);
                ...
                for (Element scenario : scenarios) {
                    ...
                    if (Util.hasScenarios(feature)) {
                       /* if (scenario.hasTags()) {
                            ...
                            System.out.print(scenario.getTagList());
                            String [] tl ={"1"};

                            tagMap = createOrAppendToTagMap(tagMap, tl  , scenarioList);
...
//        }
  ...
  /*  private List<TagObject> createOrAppendToTagMap(List<TagObject> tagMap, String [] tagList, List<ScenarioTag> scenarioList) {
    ...
    public List<TagObject> createOrAppendToTagMapByFeature(List<TagObject> tagMap, String[] tagList,
